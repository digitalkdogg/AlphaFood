...
Return a JSON object with exactly these fields:
{
  ...
  "mammal_status": <string: exactly one of "safe", "questionable", or "contains_mammal".
    ...
    - "contains_mammal": one or more ingredients are explicitly listed and are a mammal-derived product. This includes: beef, pork, veal, bacon, ham, lamb, venison, bison, buffalo, goat meat, rabbit, lard, tallow, suet, rennet, gelatin, worcestershire sauce, AND these specific dairy products — milk, butter, cream, yogurt, ghee, whey, sour cream, half-and-half, buttermilk, kefir, cream cheese, mascarpone, ricotta, creme fraiche. Only mark "contains_mammal" if the ingredient is actually present in the listed ingredients.
